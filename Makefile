...
U=
CC 		= gcc
CFLAGS		= -Wunused-function -Wstrict-prototypes -Wwrite-strings -W -Wall -g -O2 -mmacosx-version-min=10.10 -isysroot /Applications/Xcode_11.6.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.15.6.sdk
CPPFLAGS	= -I. -I$(srcdir)  -DHAVE_CONFIG_H -DLDNS_TRUST_ANCHOR_FILE="\"$(LDNS_TRUST_ANCHOR_FILE)\""
LDFLAGS		= 
LIBS 		= 
LIBOBJDIR	= compat/
...
PYTHON_LDFLAGS	= 
PYTHON_X_CFLAGS = 
LIBSSL_CPPFLAGS =  -I../OpenSSL-for-iPhone/bin/iPhoneSimulator13.4-x86_64.sdk/include
LIBSSL_LDFLAGS  =  -L../OpenSSL-for-iPhone/bin/iPhoneSimulator13.4-x86_64.sdk/lib
LIBSSL_LIBS     =  -lcrypto
LIBSSL_SSL_LIBS = -lssl  -lcrypto
LIBPCAP_LIBS    = 
RUNTIME_PATH	= 
...
all:	setup-builddir lib linktest manpages    
...
clean:    clean-manpages clean-lib  putdown-builddir
